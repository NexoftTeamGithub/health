...
Map<String, dynamic> _$HealthDataPointToJson(HealthDataPoint instance) =>
    <String, dynamic>{
      ...
      if (instance.workoutSummary?.toJson() != null)
...
Map<String, dynamic> _$HealthValueToJson(HealthValue instance) =>
    <String, dynamic>{
      if (instance.$type != null) '__type': instance.$type!,
    };
...
Map<String, dynamic> _$WorkoutHealthValueToJson(WorkoutHealthValue instance) =>
    <String, dynamic>{
      ...
      if (instance.totalEnergyBurned != null)
        'totalEnergyBurned': instance.totalEnergyBurned!,
      if (_$HealthDataUnitEnumMap[instance.totalEnergyBurnedUnit] != null)
        'totalEnergyBurnedUnit':
            _$HealthDataUnitEnumMap[instance.totalEnergyBurnedUnit]!,
      if (instance.totalDistance != null)
        'totalDistance': instance.totalDistance!,
      if (_$HealthDataUnitEnumMap[instance.totalDistanceUnit] != null)
        'totalDistanceUnit':
            _$HealthDataUnitEnumMap[instance.totalDistanceUnit]!,
      if (instance.totalSteps != null) 'totalSteps': instance.totalSteps!,
      if (_$HealthDataUnitEnumMap[instance.totalStepsUnit] != null)
...
Map<String, dynamic> _$ElectrocardiogramHealthValueToJson(
    ...
    <String, dynamic>{
      ...
      if (instance.averageHeartRate != null)
        'averageHeartRate': instance.averageHeartRate,
      if (instance.samplingFrequency != null)
...
Map<String, dynamic> _$NutritionHealthValueToJson(
    ...
    <String, dynamic>{
      ...
      if (instance.mealType != null) 'mealType': instance.mealType!,
      if (instance.calories != null) 'calories': instance.calories!,
      if (instance.protein != null) 'protein': instance.protein!,
      if (instance.fat != null) 'fat': instance.fat!,
      if (instance.carbs != null) 'carbs': instance.carbs!,
      if (instance.caffeine != null) 'caffeine': instance.caffeine!,
      if (instance.vitaminA != null) 'vitaminA': instance.vitaminA!,
      if (instance.b1Thiamine != null) 'b1Thiamine': instance.b1Thiamine!,
      if (instance.b2Riboflavin != null) 'b2Riboflavin': instance.b2Riboflavin!,
      if (instance.b3Niacin != null) 'b3Niacin': instance.b3Niacin!,
      if (instance.b5PantothenicAcid != null)
        'b5PantothenicAcid': instance.b5PantothenicAcid!,
      if (instance.b6Pyridoxine != null) 'b6Pyridoxine': instance.b6Pyridoxine!,
      if (instance.b7Biotin != null) 'b7Biotin': instance.b7Biotin!,
      if (instance.b9Folate != null) 'b9Folate': instance.b9Folate!,
      if (instance.b12Cobalamin != null) 'b12Cobalamin': instance.b12Cobalamin!,
      if (instance.vitaminC != null) 'vitaminC': instance.vitaminC!,
      if (instance.vitaminD != null) 'vitaminD': instance.vitaminD!,
      if (instance.vitaminE != null) 'vitaminE': instance.vitaminE!,
      if (instance.vitaminK != null) 'vitaminK': instance.vitaminK!,
      if (instance.calcium != null) 'calcium': instance.calcium!,
      if (instance.chloride != null) 'chloride': instance.chloride!,
      if (instance.cholesterol != null) 'cholesterol': instance.cholesterol!,
      if (instance.choline != null) 'choline': instance.choline!,
      if (instance.chromium != null) 'chromium': instance.chromium!,
      if (instance.copper != null) 'copper': instance.copper!,
      if (instance.fatUnsaturated != null)
        'fatUnsaturated': instance.fatUnsaturated!,
      if (instance.fatMonounsaturated != null)
        'fatMonounsaturated': instance.fatMonounsaturated!,
      if (instance.fatPolyunsaturated != null)
        'fatPolyunsaturated': instance.fatPolyunsaturated!,
      if (instance.fatSaturated != null) 'fatSaturated': instance.fatSaturated!,
      if (instance.fatTransMonoenoic != null)
        'fatTransMonoenoic': instance.fatTransMonoenoic!,
      if (instance.fiber != null) 'fiber': instance.fiber!,
      if (instance.iodine != null) 'iodine': instance.iodine!,
      if (instance.iron != null) 'iron': instance.iron!,
      if (instance.magnesium != null) 'magnesium': instance.magnesium!,
      if (instance.manganese != null) 'manganese': instance.manganese!,
      if (instance.molybdenum != null) 'molybdenum': instance.molybdenum!,
      if (instance.phosphorus != null) 'phosphorus': instance.phosphorus!,
      if (instance.potassium != null) 'potassium': instance.potassium!,
      if (instance.selenium != null) 'selenium': instance.selenium!,
      if (instance.sodium != null) 'sodium': instance.sodium!,
      if (instance.sugar != null) 'sugar': instance.sugar!,
      if (instance.water != null) 'water': instance.water!,
      if (instance.zinc != null) 'zinc': instance.zinc!,
    };
...
Map<String, dynamic> _$MenstruationFlowHealthValueToJson(
    ...
    <String, dynamic>{
      if (instance.$type != null) '__type': instance.$type!,
      if (_$MenstrualFlowEnumMap[instance.flow] != null)
        'flow': _$MenstrualFlowEnumMap[instance.flow]!,
      if (instance.isStartOfCycle != null)
        'isStartOfCycle': instance.isStartOfCycle!,
      if (instance.wasUserEntered != null)
